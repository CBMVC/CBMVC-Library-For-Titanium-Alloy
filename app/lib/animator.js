...
Animator = {
	 ...
	 */
	parallel: function(arrayOfAnimations) {
		if(arrayOfAnimations) {
			...
			for(var i = 0; i <= arrayOfAnimationsLength; i++) {
				...
				Animator[animation.type](animation);
			};
		}
	},
	 ...
	 * ---- arguments consult the desired animation
	 */
	sequence: function(arrayOfAnimations) {
		...
		function runNextAnimation() {
			...
			lastAnimation = Animator[arrayOfAnimations[currentAnimation].type](arrayOfAnimations[currentAnimation]);
