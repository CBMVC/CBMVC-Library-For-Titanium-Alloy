...
if(OS_IOS) {
	...
	exports.email = function(_url) {
		if(exports.emailSupported) {
			...
			email.html = true;
			email.messageBody = CB.Settings.share + "<br /><br /><a href='" + _url + "'>" + _url + "</a>";
	...
	exports.share = function(_url) {
		...
		intent.putExtra(Ti.Android.EXTRA_TEXT, CB.Settings.share + " " + _url);
